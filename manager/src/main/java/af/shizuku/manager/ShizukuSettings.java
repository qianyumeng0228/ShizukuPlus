...
public class ShizukuSettings {
    ...
    // Wallpaper theme (Shizuku+ beautification): "white_miku" = light Miku wallpaper,
     ...
     * <p>
     * The wallpaper setting doubles as the global theme control (Shizuku+ beautification):
